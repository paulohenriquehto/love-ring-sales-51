...
BEGIN
  ...
  INSERT INTO public.products (id, name, description, sku, category_id, base_price, weight, supplier_id, active)
  VALUES 
    (gen_random_uuid(), 'Aliança Clássica', 'Aliança tradicional em ouro 18k', 'ALI-001', cat_aneis_id, 850.00, 5.2, supplier_id, true),
    (gen_random_uuid(), 'Colar Pérola', 'Colar delicado com pérolas', 'COL-001', cat_colares_id, 450.00, 15.0, supplier_id, true),
    (gen_random_uuid(), 'Brincos Argola', 'Brincos de argola em prata', 'BRI-001', cat_brincos_id, 180.00, 3.5, supplier_id, true)
  RETURNING id;
