-- Step 1: Delete symbols from Signos category first to avoid foreign key constraint
DELETE FROM engraving_symbols 
WHERE category_id IN (
  SELECT id FROM engraving_categories WHERE name = 'Signos'
);
...
-- Step 3: Update sort_order for remaining categories
...
-- Step 4: Insert the 37 new zodiac symbols
