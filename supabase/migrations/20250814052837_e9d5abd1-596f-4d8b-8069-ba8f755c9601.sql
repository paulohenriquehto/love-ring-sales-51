-- Deletar variantes duplicadas se existirem
DELETE FROM public.product_variants 
WHERE product_id IN (
  SELECT id FROM public.products WHERE sku IN ('ANT33-LIFE', 'ANT08-OFME', 'ANT116-NEED')
);

-- Deletar configurações de gravação duplicadas se existirem  
